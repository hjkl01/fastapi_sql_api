...
from api.html_api import HtmlAPI
...
app.add_api_route("/api/html/insert/", html_api.html_insert, methods=["POST"])
app.add_api_route("/api/html/query/", html_api.html_query, methods=["POST"])
